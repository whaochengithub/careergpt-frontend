...
import { getRecruiterDetail } from "../../apis/recruiter/recruiterDetail"
import { postJob } from "../../apis/job/postJob"
import { editJob } from "../../apis/job/editJob"
...
const Profile = () => {
  ...
  const [editJobDetail, setEditJobDetail] = useState(null)
            ...
            <Box flex={5} padding={2}>
              ...
              <Stack spacing={2}>
                ...
                {postJobs.map((job, index) => {
                  return editJobID && editJobID === job.id ? (
                    <Card key={index}>
                      <Stack divider={<Divider variant="middle" />}>
                        <Stack
                          direction={"row"}
                          ...
                          <Box display={"flex"} alignItems={"center"} gap={2}>
                            ...
                            >
                              ...
                              >
                                {job.jobType}
                                <Select
                                  id={"position-edit-job-type"}
                                  options={[
                                    { value: "Contract", label: "Contract" },
                                    { value: "Full Time", label: "Full Time" },
                                  ]}
                                  value={{
                                    value: editJobDetail?.jobType,
                                    label: editJobDetail?.jobType,
                                  }}
                        ...
                        >
                          <BootstrapInput
                            value={editJobDetail?.description}
                            onChange={(e) => {
                              setEditJobDetail({
                                ...editJobDetail,
                        ...
                        <Button
                          ...
                          onClick={() => {
                            editJob(job.id, {
                              ...
                              jobType: editJobDetail?.jobType,
                              location: editJobDetail?.location,
