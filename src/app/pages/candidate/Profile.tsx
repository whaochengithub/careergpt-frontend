                  ...
                  {aboutEditMode ? (
                    <Stack padding={2}>
                      ...
                      <BootstrapInput
                        multiline
                        value={
                          "Served as Team leader of Android and iOS developers and worked as a developer for a US-based flight/hotel booking portal.Improved the conversion rate by 30% by incrementally improving the application based on User behavior.• Proposed, designed,"
                        }
                      />
                      <Box>
                        <Button
                    ...
                    <Typography padding={2} color={"gray"}>
                      I am a Software Engineer driven by curiosity and a
                      determination to make a positive impact through
                      technology. I am now seeking opportunities that will allow
                      me to continue growing, collaborating with talented teams.
                      I am a Software Engineer driven by curiosity and a
                      determination to make a positive impact through
                      technology. I am now seeking opportunities that will allow
                      me to continue growing, collaborating with talented teams.
                        ...
                        >
                          ...
                          <Typography component={"ul"} sx={{ pl: 1 }}>
                            <Typography
                              ...
                              component={"li"}
                            >
                              Served as Team leader of Android and iOS
                              developers and worked as a developer for a
                              US-based flight/hotel booking portal.Improved the
                              conversion rate by 30% by incrementally improving
                              the application based on User behavior.• Proposed,
                              designed, developed, and presented a new Android
                              application for a Government Bank with key banking
                              features and modern architecture. The app is live
                              with 1million+ downloads.• Used modern practices
                              to secure the API calls from the app using AES,
                              Biometrics, OAuth2. Worked with Dagger and RxJava.
                            </Typography>
                            <Typography
                              color="text.secondary"
                              variant="body2"
                            ...
                            >
                              ...
                              US-based flight/hotel booking portal. Improved the
                              conversion rate by 30% by incrementally improving
                              the application based on User behavior. •
                              Proposed, designed, developed, and presented a new
                              Android application for a Government Bank with key
                              banking features and modern architecture. The app
                              is live with 1million+ downloads. • Used modern
                              practices to secure the API calls from the app
                              using AES, Biometrics, OAuth2. Worked with Dagger
                              and RxJava.
                            </Typography>
                            <Typography
                              color="text.secondary"
                              ...
                              component={"li"}
                            >
                              Skills: Android · Retrofit · Guava ·
                              Model-view-viewmodel (MVVM) · Dagger (Software) ·
                              Git · RxJava · Software Development
                            </Typography>
                          </Typography>
                        </Stack>
                      </Stack>
